...
int main( int argc, char** argv )
{
 ...
 /* przyjmuje na razie stale z poprzedniej optymalizacji
  ...
  */
  ...
  else
  {
    ...
    for(int i=0; i< liczba_czastek_pso; ++i)
    {
      ...
      */ //bo przyjmuje stale
      parametry_pso[i].error_threshold1 = 0.059989; //0.059989 0.890247 0.068388 0.891865 0.000010
      parametry_pso[i].pewnosc_1 = 0.890247;
      parametry_pso[i].error_threshold2 = 0.068388;
      parametry_pso[i].pewnosc_2 = 0.891865;
      ...
      /* ustawiam na 0 bo nie aktualizuje potem a chce widziec w logach
      ...
      */
      parametry_pso[i].predkosc_error_threshold1 = 0;
      parametry_pso[i].predkosc_pewnosc_1 = 0;
      parametry_pso[i].predkosc_error_threshold2 = 0;
      parametry_pso[i].predkosc_pewnosc_2 = 0;
